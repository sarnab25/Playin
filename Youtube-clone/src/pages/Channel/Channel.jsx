...
function Channel({setvideoUploadPage, setEditCreateChannelbtn}) {
    const {id}=useParams()
    const vids=useSelector((state)=>state.videoReducer)?.data?.filter(q=>q.videochannnel===id).reverse()
  ...
  return (
    <div className='container_pages_app'>
        ...
        <div className="container2_pages_app">
            <DescribeChannel id={id} setEditCreateChannelbtn={setEditCreateChannelbtn} setvideoUploadPage={setvideoUploadPage}/>
